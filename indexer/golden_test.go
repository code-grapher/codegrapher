...
func TestGoldenInit(t *testing.T) {
	for _, fixture := range []string{"go-small", "ts-small", "py-small", "cs-small", "java-small", "kt-small", "rb-small", "rs-small", "php-small", "c-small", "cpp-small", "scala-small", "swift-small", "dart-small"} {
