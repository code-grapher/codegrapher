...
| [whole-repo-file-nodes](whole-repo-file-nodes/README.md) | Approved | Emit a file-level node for every non-gitignored file, not only files in recognized source languages. |
