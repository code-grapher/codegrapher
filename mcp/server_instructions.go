...
// ServerInstructions is the server-level instructions text sent in the MCP
// initialize response. Copied verbatim from src/mcp/server-instructions.ts.
const ServerInstructions = `# Codegraph — code intelligence over an indexed knowledge graph
